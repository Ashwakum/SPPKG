...
var SecondaryGroupConnector = /** @class */ (function (_super) {
    ...
    SecondaryGroupConnector.prototype.render = function () {
        ...
        var secondaryConnectorClassName = office_ui_fabric_react_bundle_1.css(PropertyPaneConditionalGroup_module_scss_1.default.alternateFieldsConnector, sp_core_library_1._BrowserDetection.getBrowserInformation().os === sp_core_library_1._OS.Mac ? PropertyPaneConditionalGroup_module_scss_1.default.mac_only : '', !KillSwitches_1.default.expandAlternateFieldsConnectorMarginKSActivated()
            ? PropertyPaneConditionalGroup_module_scss_1.default.expandAlternateFieldsConnectorMargin
            : '');
