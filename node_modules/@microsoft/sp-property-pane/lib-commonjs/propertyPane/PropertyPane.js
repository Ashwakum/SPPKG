...
var PropertyPane = /** @class */ (function (_super) {
    ...
    function PropertyPane(props) {
        ...
        for (var _i = 0, debounceProperties_1 = debounceProperties; _i < debounceProperties_1.length; _i++) {
            ...
            _this._debounceCallbacks.set(propertyName, sp_lodash_subset_1.debounce(_this._raiseEventImpl, debouncePeriod, { leading: true, trailing: true }));
        }
    ...
    PropertyPane.prototype.render = function () {
        ...
        return (React.createElement(office_ui_fabric_react_bundle_1.Fabric, { "data-sp-feature-tag": 'Property Pane', "data-sp-feature-instance-id": '_Property Pane' },
            (KillSwitches_1.isFixEmptyAlertAndFocusKSActivated() || this.state.saveConfirmationMessage) && (React.createElement("div", { role: 'alert', "aria-live": 'polite', className: PropertyPane_module_scss_1.default.propertyPaneScreenReaderOnly },
            ...
            React.createElement(office_ui_fabric_react_bundle_1.FocusTrapZone, { isClickableOutsideFocusTrap: true, forceFocusInsideTrap: false, disabled: this.props.data.configuration.disableFocusTrap },
                React.createElement("div", { className: this.props.renderNarrow
                        ...
                        : PropertyPane_module_scss_1.default.propertyPane, role: 'region', "aria-label": !KillSwitches_1.isUpdatePropertyPaneAriaLabelKSActivated()
                        ? sp_core_library_1.Text.format(strings.UpdatedPropertyPaneAriaLabel, this.props.data.title)
                        : strings.PropertyPaneAriaLabel, "aria-describedby": this._descriptionId, ref: this._propertyPane, onKeyDown: this._onPropertyPaneKeyDown, key: this.props.data.webPartId },
    ...
    PropertyPane.prototype._renderPage = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("div", { className: office_ui_fabric_react_bundle_1.css(classForPropertyPanePageContentBottom, PropertyPanePage_module_scss_1.default.propertyPanePageContent), "data-automation-id": 'propertyPanePageContent' },
                React.createElement("div", null, this.props.children),
    ...
    PropertyPane.prototype._onPropertyPaneKeyDown = function (ev) {
        if (CanvasA11y_1.isKey(office_ui_fabric_react_bundle_1.KeyCodes.escape, ev) && !ev.defaultPrevented) {
            ev.preventDefault();
    ...
    PropertyPane.prototype._focusOnFirstActionableElement = function () {
        ...
        if (propertyPane) {
            ...
            if (firstElement) {
            ...
            else if (!KillSwitches_1.isFixEmptyAlertAndFocusKSActivated() &&
                !this._shouldRenderEmptyPage &&
                this._propertyPane.current) {
                ...
                (_a = CanvasA11y_1.getFirstFocusableChild(this._propertyPane.current)) === null || _a === void 0 ? void 0 : _a.focus();
            }
        }
    };
    /**
