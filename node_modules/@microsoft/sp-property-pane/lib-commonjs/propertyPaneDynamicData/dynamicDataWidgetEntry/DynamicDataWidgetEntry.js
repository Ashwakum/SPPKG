...
var DynamicDataWidgetEntry = /** @class */ (function (_super) {
    ...
    DynamicDataWidgetEntry.prototype._getDropdownForSubProperty = function (level, propertyPath, selectedKey) {
        ...
        if (level === 0 && !KillSwitches_1.default.isSubPropertyLabelOverrideKillSwitchActivated()) {
            this._parentSelectedKey = selectedKey || this._selectedSubPropertyText;
        }
        var labelTxt = KillSwitches_1.default.isSubPropertyLabelOverrideKillSwitchActivated() && level === 0
            ? sp_core_library_1.Text.format(Strings.DynamicDataPropertiesDropdownLabel, selectedText)
            : selectedText;
