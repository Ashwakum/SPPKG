...
var PropertyPaneFooter = /** @class */ (function (_super) {
    ...
    PropertyPaneFooter.prototype._pageNavigationButtons = function () {
        return (this.props.numberOfPages > 1 && (React.createElement("div", { className: PropertyPaneFooter_module_scss_1.default.propertyPanePageNav },
            ...
            React.createElement("span", { role: 'status', className: office_ui_fabric_react_bundle_1.css(PropertyPaneFooter_module_scss_1.default.propertyPanePageOfPages) }, sp_core_library_1.Text.format(strings.PropertyPanePageOfPages, this.props.currentPage, this.props.numberOfPages)),
            React.createElement("button", { className: PropertyPaneFooter_module_scss_1.default.propertyPaneNextNavLink, disabled: this.props.currentPage === this.props.numberOfPages, onClick: this._onNextClick },
                ...
                React.createElement("i", { className: office_ui_fabric_react_bundle_1.css(this._arrowKeyIcon(PropertyPane_1.PageDirection.next), PropertyPaneFooter_module_scss_1.default.propertyPaneNextArrow) }))))); // tslint:disable-line:no-any
    };
