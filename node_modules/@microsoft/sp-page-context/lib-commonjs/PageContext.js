...
var PageContext = /** @class */ (function () {
        ...
        switch (propertyId) {
            ...
            case PageContext._pageContextSearchDataDynamicProperty:
                propMetadata = {
                    ...
                    searchScope: {
                        title: strings.ddvSearchScope,
                        description: strings.ddvSearchScopeDesc
                    }
                };
                break;
        }
    ...
    PageContext.prototype._isQueryStringParamsKSActivated = function () {
        return sp_core_library_1._SPKillSwitch.isActivated('a7c756f2-39a2-4d56-b46e-d6fd3fb056c7' /* '12/02/2020', 'Use URLSearchParams to extract query string params'*/);
    };
    /**
